...
def train(args, module, optimizer, criterion, scheduler, train_loader, val_loader, epoch):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch_size', type=int, default=20, help='patch size during data processing')
    parser.add_argument('--image_size', type=int, default=100, help='size of the input data')
    # training parameters
    ...
    for epoch in range(start_epoch, args.n_epochs + 1):
        ...
        if epoch < args.n_epochs:
            train_loss, val_loss = train(args=args, module=module, optimizer=optimizer, criterion=criterion,
                                           scheduler=scheduler, train_loader=train_loader, val_loader=val_loader, epoch=epoch)
            # metrics = {
